const weaponPrompt = `Generate a list of 20 random weapon options. Make one of these weapons a silly item, but do not use the word silly. Make one of these weapons an item that could be purchased for less than $5.
